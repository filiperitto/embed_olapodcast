//== Accordion Module
(function () {
  let accTitle = document.getElementsByClassName("header-acc-embed_olapodcast");
  let accContent = document.getElementsByClassName(
    "acc-content-embed_olapodcast"
  );
  let singleMode = true;
  ...
  for (let i = 0; i < accTitle.length; i++) {
    accTitle[i].onclick = function () {
      ...
      document.getElementById(openedAcc).style.height = accContent[
        i
